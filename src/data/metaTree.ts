...
export const META_TREE: MetaNodeDef[] = [
  ...
  },
  {
    ...
    name: 'Glassforge',
    description: 'KEYSTONE — Honed Edge grants 15% more damage (rounded down), but the Spire has 40% less max HP. Invest deeply in Iron.',
    maxLevel: 1,
    costs: [1200],
    branch: 'iron',
    tier: 2,
...
// all read one source.
export const KEYSTONE_GLASSFORGE_EDGE_BOOST_PCT = 15
