...
describe('createRun applies meta', () => {
  it('fresh meta yields base stats and locked content', () => {
    ...
    expect(run.mods).toEqual({ damagePct: 0, goldPct: 0, sparkPct: 0, critChancePct: 0, abilityCdPct: 0, repairCasts: 0, collectRadius: COLLECT_RADIUS_BASE, autoCollectRadius: 0, executeCdPct: 0, overchargeCdPct: 0, veteranDamagePct: 0, relicChoices: 0, bonusCharges: 0 })
  })
